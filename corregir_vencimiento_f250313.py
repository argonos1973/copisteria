...
print('=== CORREGIR FECHA DE VENCIMIENTO F250313 ===\n')
...
print(f'Fecha emisión: {fecha_emision.strftime("%d/%m/%Y")}')
...
print('✅ fecha_ultima_carta reseteada para forzar envío')
