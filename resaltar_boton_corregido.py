...
def main():
    ...
    with sync_playwright() as p:
        try:
            ...
            # Navegar a una página de ejemplo (reemplazar con la URL real del banco)
            logging.info("Navegando a la página de movimientos del banco")
            # NOTA: Reemplazar esta URL con la URL real de la página de movimientos del banco Santander
            page.goto("https://www.santander.es", timeout=30000)
