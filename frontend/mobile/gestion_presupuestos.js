...
async function cargarPresupuesto(id) {
    try {
        ...
        document.getElementById('page-title').textContent = data.numero || 'Editar Presupuesto';
...
async function guardarPresupuesto() {
    ...
    try {
        ...
        window.location.href = '/api/auth/mobile/presupuestos';
