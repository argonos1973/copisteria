...
def main():
    """Función principal"""
    logging.info("Iniciando captura rápida")
    ...
    with sync_playwright() as p:
        try:
            # Lanzar el navegador en modo headless para evitar problemas de visualización
            ...
            # Guardar evidencia de la página de cuentas inmediatamente
            ruta_evidencia = guardar_evidencia_html(page, "pagina_cuentas_rapida", directorio_evidencias)
